...
public class QuarterCenturyMenuKeyboard {
    ...
    private static final String CONTROL_QUARTER_CENTURY = "control_quarter_century_";
    ...
    public InlineKeyboardMarkup constructQuarterCenturyMenu(LocalDate localDate) {
        ...
        InlineKeyboardButton moveLeft = InlineKeyboardButton.builder()
                .text("⬅️ Previous")
                .callbackData(CONTROL_QUARTER_CENTURY + localDate.minusYears(25))
                .build();
//        System.out.println(localDate.minusMonths(1));
        InlineKeyboardButton moveRight = InlineKeyboardButton.builder()
                .text("Next ➡️")
                .callbackData(CONTROL_QUARTER_CENTURY + localDate.plusYears(25))
                .build();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 5; j++) {
                InlineKeyboardButton yearButton = InlineKeyboardButton.builder()
                        .text(String.valueOf(rangeStart + i + j))
                        .callbackData(YearMenuKeyboard.CONTROL_YEAR +
